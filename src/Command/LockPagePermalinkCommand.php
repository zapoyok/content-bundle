...
class LockPagePermalinkCommand extends ContainerAwareCommand
{
    protected $em;
    ...
    {
        $this
            ->setName('zapoyok:content:page:lock')
            ->setDescription('')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null !== ($page = $this->pageManager->findOneByPermalink($input->getArgument('permalink')))) {
            ...
            $output->writeln(sprintf('Page #%d « %s » Locked', $page->getId(), $input->getArgument('permalink')));
        } else {
